import { createOrder, CartToOrderProducts,getOrder,cancelOrder,getUserAllOrders,getAdminAssociatedOrders,updateorderstatus } from '../models/Orders.js';
...
export const createOrderController = async (req, res) => {
    ...
    try {
        ...
        const newOrder = await createOrder(user_id,shipping_address,total_amount);
...
export const  getAdminAssociatedOrdersController = async (req,res) => {
     ...
     try{
        ...
        console.error('Error in getAdminAssociatedOrdersController:', error.message);
...
export const Updateorderstatuscontroller = async (order_id,status) => {
    ...
    try{
        ...
        const result=await updateorderstatus(order_id,status,admin_username);
